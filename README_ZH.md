...
- 技术集成：[业务项目接入指南](docs/i18n/zh/integration/getting-started-for-business-projects.md)、[采用就绪度与已验证范围](docs/i18n/zh/integration/adoption-readiness.md)、[聚合持久化](docs/i18n/zh/capabilities/aggregate-persistence.md)、[可靠消息](docs/i18n/zh/capabilities/reliable-messaging.md)
