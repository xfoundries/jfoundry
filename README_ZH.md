...
- 技术集成：[业务项目接入指南](docs/i18n/zh/integration/getting-started-for-business-projects.md)、[采用就绪度与已验证范围](docs/i18n/zh/integration/adoption-readiness.md)、[持久化 DataMapper 与 MapStruct 使用指南](docs/i18n/zh/integration/persistence-data-mappers.md)、[Transactional Outbox 事务性发件箱](docs/i18n/zh/integration/transactional-outbox.md)
