...
5. Does README or `../../../docs/i18n/en/integration/getting-started-for-business-projects.md` need an update? If the change affects localized user guidance, update the matching `../../../docs/i18n/zh/` page too.
