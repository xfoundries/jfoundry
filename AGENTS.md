...
- `jfoundry-core/jfoundry-starters` and `jfoundry-runtime-integrations/jfoundry-spring/boot-starters` should assemble existing capabilities; avoid placing domain logic, persistence logic, or broker-specific behavior directly in starters.
