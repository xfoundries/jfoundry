...
/// Translates Hibernate availability failures at a JPA persistence boundary.
@DefaultBean
@ApplicationScoped
public final class QuarkusJpaPersistenceFailureTranslator implements PersistenceFailureTranslator {
