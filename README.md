...
| Runtime integration | Spring Framework and Spring Boot assembly; Quarkus CDI, Jakarta Transactions, and explicit Outbox externalization assembly |
...
- **Quarkus**: use [Quarkus Runtime Integration](docs/i18n/en/implementations/quarkus.md) for CDI transactions, domain-event dispatch, explicit Outbox externalization, and Native Image verification.
